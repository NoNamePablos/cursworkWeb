...
<div class="container">
	...
	<div class="card-form">
		<div class="card-form-wrapper">
			<h2 class="card-form__title title-clash title-clash-2">Восстановление</h2>
			...
			<form action="newpass.php" method="get" class="card-form-form">
				...
				<div class="card-form-form__item">
					<button name="btn-update-pass" type="submit" class="card-form-form__button button button-dark-purple button-no-border">Восстановить</button>
				</div>
			</form>
		</div>
	</div>
